...
Tick off as files land. Mirrors the structure in admin-frontend.md §3.

### Root
- [ ] `proxy.ts` (P2)
- [ ] `components.json` (P1, generated by shadcn init)
- [ ] `.env.local`, `.env.example` (P0)
- [ ] `package.json` dev script port (P0)

### `app/`
- [ ] `app/layout.tsx` updated with `<Providers>`, `<Toaster>` (P1)
- [ ] `app/page.tsx` redirects to `/dashboard` (P2)
- [ ] `app/login/page.tsx` (P2)
- [ ] `app/(admin)/layout.tsx` (P3)
- [ ] `app/(admin)/dashboard/page.tsx` (P4)
- [ ] `app/(admin)/products/page.tsx` (P5)
- [ ] `app/(admin)/products/[id]/page.tsx` (P5)
- [ ] `app/(admin)/orders/page.tsx` (P6)
- [ ] `app/(admin)/orders/[id]/page.tsx` (P6)
- [ ] `app/(admin)/users/page.tsx` (P7)
- [ ] `app/(admin)/users/[id]/page.tsx` (P7)
- [ ] `app/(admin)/audit/page.tsx` (P8)
- [ ] `app/assets/satoshi/*.otf` (P0 — drop-in)

### `lib/`
- [ ] `lib/types.ts` (P1)
- [ ] `lib/utils.ts` (P1, by shadcn init — `cn()` helper)
- [ ] `lib/api/client.ts` (P1)
- [ ] `lib/api/auth.ts` (P1)
- [ ] `lib/api/stats.ts` (P1)
- [ ] `lib/api/users.ts` (P1)
- [ ] `lib/api/orders.ts` (P1)
- [ ] `lib/api/products.ts` (P1)
- [ ] `lib/api/audit.ts` (P1)

### `hooks/`
- [ ] `hooks/use-auth.ts` (P2)

### `components/layout/`
- [ ] `components/layout/providers.tsx` (P1)
- [ ] `components/layout/nav-items.ts` (P3)
- [ ] `components/layout/sidebar.tsx` (P3)
- [ ] `components/layout/header.tsx` (P3)

### `components/shared/`
- [ ] `components/shared/page-header.tsx` (P3)
- [ ] `components/shared/empty-state.tsx` (P3)
- [ ] `components/shared/pagination-controls.tsx` (P3)
- [ ] `components/shared/stat-card.tsx` (P4)
- [ ] `components/shared/status-badge.tsx` (P6)
- [ ] `components/shared/confirm-dialog.tsx` (P6)
- [ ] `components/shared/data-table.tsx` (P5 if extracting; otherwise inline)

### `components/features/`
- [ ] `components/features/dashboard/orders-chart.tsx` (P4)
- [ ] `components/features/dashboard/revenue-chart.tsx` (P4)
- [ ] `components/features/products/create-product-dialog.tsx` (P5)
- [ ] `components/features/products/upload-vouchers-dialog.tsx` (P5)
- [ ] `components/features/orders/order-filters.tsx` (P6)
- [ ] `components/features/users/pin-status-card.tsx` (P7)

### `components/ui/` (shadcn primitives, added by `shadcn add` per phase)
- [ ] P2: `button card input label form sonner`
- [ ] P3: `skeleton badge avatar dropdown-menu tooltip separator alert sheet`
- [ ] P5: `tabs dialog textarea select`
- [ ] P6: `popover calendar`
